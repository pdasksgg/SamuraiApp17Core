...
namespace SamuraiWebApiCore
{
    public class Startup
    {
        ...
        {
            //letting the service know that we are going to use Ef DbContext
            //here samurai context,any time there is a need of SamuraiContext
